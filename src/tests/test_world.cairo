...
mod tests {
    ...
    use neon_sentinel::models::{Direction, Moves, Position, m_Moves, m_Position};
    use neon_sentinel::systems::actions::{IActionsDispatcher, IActionsDispatcherTrait, actions};
    ...
    fn contract_defs() -> Span<ContractDef> {
        [
            ContractDefTrait::new(@"neon_sentinel", @"actions")
                .with_writer_of([dojo::utils::bytearray_hash(@"neon_sentinel")].span())
        ]
            .span()
    }
