use neon_sentinel::models::{Direction, Position};
...
pub mod actions {
    ...
    use neon_sentinel::models::{Moves, Vec2};
    ...
    impl InternalImpl of InternalTrait {
        /// Use the default namespace "neon_sentinel". This function is handy since the ByteArray
        /// can't be const.
