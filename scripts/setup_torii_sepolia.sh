...
SERVICE_NAME="${1:-neon-sentinel-test}"
DOJO_VERSION="v1.8.0"
...
echo "  RPC:          $RPC_URL"
echo ""
echo "If you already have a Torii for an old world, delete it first:"
echo "  slot deployments delete $SERVICE_NAME torii"
echo ""
...
echo ""
echo "Deployment success. Use these endpoints in your client:"
echo "  Torii base:  https://api.cartridge.gg/x/$SERVICE_NAME/torii"
echo "  GraphQL:     https://api.cartridge.gg/x/$SERVICE_NAME/torii/graphql"
echo "  Stream logs: slot deployments logs $SERVICE_NAME torii -f"
